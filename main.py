...
Label(sroot,text="Saurabh And Sanskar",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="MINI PROJECT",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Saurabh and Sanskar',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Saurabh",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Mr Sanskar",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
